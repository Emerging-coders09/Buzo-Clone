...
public class RatingActivity extends Dialog {
    ...
    public RatingActivity(Activity activity,NativeAd ad) {
        super(activity);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rate_app_layout_file);

        RatingBar ratingBar = findViewById(R.id.rBForBuzoClone);
        ...
        AdLoader adLoader = builder.forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
            ...
            public void onNativeAdLoaded(@NonNull NativeAd nativeAd) {
                ad = nativeAd;
                FrameLayout frameLayout = findViewById(R.id.frameLayout_holder);
                NativeAdView adView =
